...
module.exports = YardiBComparsion121314;

//Class Constructor 
function YardiBComparsion121314() {

}
 
YardiBComparsion121314.prototype.parseFile = function (fileBuffer, fileName, originalFileName) {
	...
	var cashFlowNetIncomeColumnName = "Property Net Operating Income";
				...
				if (!isAddressFound) {
                    for(cellIndex = 0; cellIndex < cells.length; cellIndex++){
						...
						if(cellValue.indexOf(budget) > -1){
							...
							address[1] = address[1].substring(0,address[1].indexOf("(")).trim();
