...
//                 // var numberOfProperties = parseInt(level.numberOfProperties);
//                 var netTax = parseInt(level.netTax);

//                 if (!isNumeric(value))
//                     value = 1;

//                 // if (!isNumeric(numberOfProperties))
...
//                     result = result * netTax;
//                 }

//                 // if (financialTerm.columns.numberOfProperties) {
//                 //     result = result * numberOfProperties;
//                 // }

//                 financialTerm.value[i].calculatedFee = result;
...
//             // var numberOfProperties = parseInt(financialTerm.numberOfProperties);
